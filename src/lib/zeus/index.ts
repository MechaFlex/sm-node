...
export type ValueTypes = {
	...
	nick: string | Variable<any, string>
};
	["Mutation"]: AliasType<{
createUser?: [{	user: ValueTypes["CreateUser"] | Variable<any, string>},boolean | `@${string}`],
deleteUser?: [{	id: string | Variable<any, string>},boolean | `@${string}`],
...
export type ResolverInputTypes = {
	...
	["Mutation"]: AliasType<{
createUser?: [{	user: ResolverInputTypes["CreateUser"]},boolean | `@${string}`],
...
type ZEUS_VARIABLES = {
	["CreateUser"]: ValueTypes["CreateUser"];
}